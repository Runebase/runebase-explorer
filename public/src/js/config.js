...
.constant('Constants', {
    ...
    DEFAULT_CURRENCY: localStorage.getItem('insight-currency') || 'RUNEBASE',
...
angular.module('insight').config(function($routeProvider) {
	...
	when('/blocks', {
		...
		title: 'Runebase Blocks solved Today'
	}).
	when('/blocks-date/:blockDate/:startTimestamp?', {
		templateUrl: 'views/block_list.html',
		title: 'Runebase Blocks solved '
	}).
